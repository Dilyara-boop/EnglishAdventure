...
const QUESTION_BANK = [
  { question: 'Kate has a bike. It is ___ bike.', options: ['her', 'his', 'our'], correct: 'her' },
  { question: 'Tom has a kite. It is ___ kite.', options: ['her', 'his', 'their'], correct: 'his' },
  { question: 'I have a sister. ___ name is Ann.', options: ['Her', 'His', 'Its'], correct: 'Her' },
  { question: 'We have a dog. ___ dog is funny.', options: ['Our', 'Their', 'Your'], correct: 'Our' },
  { question: 'They have a house. It is ___ house.', options: ['our', 'their', 'his'], correct: 'their' },
  { question: 'You have a brother. ___ brother is ten.', options: ['Your', 'Her', 'Our'], correct: 'Your' },
  { question: 'My father has a car. It is ___ car.', options: ['his', 'her', 'its'], correct: 'his' },
  { question: 'My mother has a bag. It is ___ bag.', options: ['his', 'her', 'our'], correct: 'her' },
  { question: 'The cat has a toy. It is ___ toy.', options: ['its', 'his', 'their'], correct: 'its' },
  { question: 'I have a book. It is ___ book.', options: ['my', 'your', 'her'], correct: 'my' }
];
...
function restartGame() {
  ...
  setFoxyMessage('Ready for the Family Challenge?');
  renderQuestion();
}
...
function finishQuiz() {
  ...
  if (passed) {
    ...
    ui.resultTitle.textContent = 'Amazing! You passed the Family Challenge! 🎉';
    ui.modalActionBtn.textContent = 'PLAY AGAIN';
    setFoxyMessage('Amazing! You know the family words! 🎉');
    playSound('victory');
