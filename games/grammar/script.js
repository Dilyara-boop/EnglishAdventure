...
const QUESTION_BANK = [
  ...
  { question: 'She ___ my teacher.', options: ['am', 'is', 'are'], correct: 'is' },
  { question: 'We ___ in the classroom.', options: ['am', 'is', 'are'], correct: 'are' },
  { question: 'Tom is my friend. ___ is ten.', options: ['He', 'She', 'It'], correct: 'He' },
  { question: 'Anna is my sister. ___ is eleven.', options: ['He', 'She', 'They'], correct: 'She' },
  { question: 'This is ___ schoolbag.', options: ['my', 'I', 'me'], correct: 'my' },
  { question: 'Peter has a pencil. It is ___ pencil.', options: ['his', 'her', 'my'], correct: 'his' },
  { question: 'Kate has a book. It is ___ book.', options: ['his', 'her', 'your'], correct: 'her' },
  { question: 'Open ___ book.', options: ['your', 'you', 'yours'], correct: 'your' },
  { question: '___ down, please.', options: ['Sit', 'Sits', 'Sitting'], correct: 'Sit' }
];
...
function restartGame() {
  ...
  setFoxyMessage('Ready for the Grammar Challenge?');
  renderQuestion();
}
...
function finishQuiz() {
  ...
  if (passed) {
    ...
    ui.resultTitle.textContent = 'Amazing! You passed the Grammar Challenge! 🎉';
    ui.modalActionBtn.textContent = 'PLAY AGAIN';
    setFoxyMessage('Amazing! You passed the Grammar Challenge! 🎉');
    playSound('victory');
